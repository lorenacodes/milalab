...
function _adminRenderUsers(users) {
 ...
 el.innerHTML = users.map(function(u) {
  ...
  return '<div id="adm-user-card-'+uid+'" style="border:1px solid var(--border);border-radius:12px;background:var(--surface);overflow:hidden">'
   ...
   +'<div style="flex:1"><label style="font-size:10px;font-weight:600;color:var(--muted);text-transform:uppercase;letter-spacing:.4px;display:block;margin-bottom:5px">Nova senha (mín. 8 caracteres) <span class="req">*</span></label>'
