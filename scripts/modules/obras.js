...
// scripts/lib/user-select.js) — value é o e-mail (o que _spNovoProj.
...
function _spProjRespDropdownMarkup() {
 ...
 return _usMultiDropdownHTML(usuarios, sel, '_spProjRespToggle(this.value,this.checked)', 'Selecione o(s) responsável(is)...');
}
